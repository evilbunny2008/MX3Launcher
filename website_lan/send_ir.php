...
$ir_payload = array(
	...
	"TCL_MUTE" => "B7EPsQ/+AbYH4AUDAeQDgAPgBxfAD8AfwAfgDxcH5AP+AeQD/gE=",
	"TCL_ON" => "B64Prg/vAcMH4AUDAfkDgANAF0AL4AcHQBPgAwNAH0ADQBPgCwcHgCCuD64P7wFAG+ADA0AvQANAE+ALB0AT4AMDQCdAA0AT4AgHAgfvAQ==",
...
if(!isset($_GET['ir_codes_to_send']) || trim($_GET['ir_codes_to_send']) == "")
{
	echo json_encode(["ok" => false, "action" => "missing"]);
	exit;
}
